...
- [ ] **[UI stories only]** Verify in browser if browser tools available
```

**Important:**
- Acceptance criteria must be verifiable, not vague.
- **For any story with UI changes:** Include "Verify in browser if browser tools available" as acceptance criteria.
